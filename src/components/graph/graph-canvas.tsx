...
export function GraphCanvas({ standards, filters, selectedNode, onNodeSelect, path }: GraphCanvasProps) {
  ...
  useEffect(() => {
    ...
    cyRef.current = cytoscape({
      ...
      style: [
        { selector: "node", style: { "background-color": "var(--card)", "border-color": "var(--border)", "border-width": 1.5, color: "var(--foreground)", label: "data(label)", "text-valign": "center", "text-halign": "center", "font-size": "10px", "font-family": "var(--font-sans)", width: "60px", height: "28px", shape: "round-rectangle" } },
        ...
        { selector: "node.selected", style: { "border-color": "var(--ring)", "border-width": 2 } },
        { selector: "edge", style: { width: 1.25, opacity: 0.85, "line-color": "var(--muted-foreground)", "target-arrow-color": "var(--muted-foreground)", "target-arrow-shape": "triangle", "arrow-scale": 0.7, "curve-style": "straight" } },
